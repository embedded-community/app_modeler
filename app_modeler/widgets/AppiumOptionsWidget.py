...
class AppiumOptionsWidget(SettingsWidget):
    ...
    def setup_ui(self):
        ...
        self.options_combo.setObjectName('appium_driver_selector')
        self.options_combo.addItems(self._appium_options.keys())
        self.options_combo.currentTextChanged.connect(self.on_option_changed)
        self.appium_group_box_layout.addWidget(self.options_combo)
        ...
        self.on_option_changed(self.options_combo.currentText())
